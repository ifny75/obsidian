/*
  ...
  Копия — это страховка, а не удобство: если сервер лежит или секрет разошёлся,
  письмо человека не должно исчезнуть бесследно. Поддержка, которая молча
  теряет обращения, хуже отсутствующей — на отсутствующую хотя бы не надеются.
...
export default {
  async email(message, env) {
    ...
    // Сначала пересылка: она дешевле и не зависит от нашего сервера.
