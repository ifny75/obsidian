...
pub enum Command {
    ...
    RecoverySetup { login: String, password: String },
    ...
    RecoverPassword { url: String, login: String, password: String },
...
pub enum Event {
    ...
    /// Код восстановления. Показывать один раз и просить записать: он
    /// равносилен личности, и в логи или скриншоты ему нельзя.
    RecoveryCode { code: String },
    /// Посылка легла на сервер: вход по этому логину теперь работает.
    RecoverySaved { login: String },
